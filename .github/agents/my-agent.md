---
name: Game MUD hậu tận thế vong tích thành
description: **hậu tận thế** (post-apocalyptic).

Đây là một thế giới MUD (game nhập vai văn bản) diễn ra tại một "thành phố đã sụp đổ" hoặc "vong tích" (thành phố bị lãng quên/hủy hoại).
---
